...
use sp_core::{ByteArray, dilithium2::{Pair, Public, Signature}, H256, Pair as PairT};
...
impl Keyring {
	...
	pub fn to_raw_public(self) -> [u8; 1312] {
...
impl From<Keyring> for sp_runtime::MultiSigner {
	fn from(x: Keyring) -> Self {
		sp_runtime::MultiSigner::Dilithium2(x.into())
	}
}
...
impl AsRef<[u8; 1312]> for Keyring {
...
#[cfg(test)]
mod tests {
	use sp_core::{dilithium2::Pair, Pair as PairT};
